...
interface DeliveryPlayerPageProps {
	user?: UserType;
	// users?: UserType[];
}
...
const DeliveryPlayerPage: React.FC<DeliveryPlayerPageProps> = (props) => {
            ...
            <DefaultLayout>
				<section className="flex flex-col items-center justify-center gap-1 py-0 md:py-4">
					<div className="flex flex-col px-4 py-4 items-center text-center justify-center bg-onBackground">
						<Marketer />
						<h1 className={title()}>مسئول پخش</h1>
						...
						{/* <h1 className={subtitle()}>Purchase Supplier Table</h1> */}
						{/* <span className='mb-4 text-textCloudy'>
...
export default DeliveryPlayerPage;
