...
interface PackagingSupervisorProps {
	user?: UserType;
	// users?: UserType[];
}
...
const PackagingSupervisorPage: React.FC<PackagingSupervisorProps> = (props) => {
            ...
            <DefaultLayout>
				<section className="flex flex-col items-center justify-center gap-1 py-0 md:py-4">
					<div className="flex flex-col px-4 py-4 items-center text-center justify-center bg-onBackground">
						<Marketer />
						<h1 className={title()}>سرپرست بسته بندی</h1>
...
export default PackagingSupervisorPage;
